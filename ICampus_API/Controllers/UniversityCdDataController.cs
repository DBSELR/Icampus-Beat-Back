...
namespace ICampus_Api.Controllers
{
    ...
    public class UniversityCdDataController : BaseApiController
    {
        private readonly IUniversityCdDataService _svc;

        public UniversityCdDataController(IUniversityCdDataService svc)
        {
            _svc = svc;
        }

        // GET api/universitycddata/batch?course=BTECH&regulation=R20
        ...
        // GET api/universitycddata/sem?course=BTECH&examMY=NOV2024&regulation=R20
        // SubjectData_LoadSemesters → ddlSemester
        // SP: Proc_SubjectData_LoadSem (@Course, @ExamMY, @Regulation)   [shared with UniversitySubjectData]
        [HttpGet("sem")]
        ...
        // GET api/universitycddata/subject-list?course=BTECH&regulation=R20&examMY=NOV2024&sem=1
        // btnSubjectList_Click → "Subjects Data"
        // SP: Proc_University_SubjectList_CD (@Course, @Regulation, @ExamMY, @Sem)
        ...
        // GET api/universitycddata/students-data?course=BTECH&regulation=R20&examMY=NOV2024&sem=1&regSup=REG
        // btnStudentData_Click → "Students Data"
        // SP: Proc_University_CD_Data (@Course, @Regulation, @ExamMY, @Sem, @RegSup)
