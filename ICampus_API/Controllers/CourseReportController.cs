...
public class CourseReportController : BaseApiController
{
    private readonly ICourseReportService _svc;
    public CourseReportController(ICourseReportService svc) => _svc = svc;
    ...
    // GET api/subject/batches?course=B.Tech&regulation=R24
    [HttpGet("batches")]
    ...
    // GET api/subject/branches?course=B.Tech&regulation=R24&batch=24
    [HttpGet("branches")]
    ...
    // GET api/subject/sems?course=B.Tech&regulation=R24&batch=24
    [HttpGet("sems")]
    ...
    // POST api/subject/papers  (body: PapersListRequest)
    [HttpPost("papers")]
    public async Task<IActionResult> GetPapers([FromBody] PapersListRequest request)
    {
    ...
    // Optional: run IAS or result process endpoints (map to DAL functions)
    //[HttpPost("run/ias")]
    ...
    //public async Task<IActionResult> RunResultProcess([FromBody] SubjectProcessRequest req)
    //{
