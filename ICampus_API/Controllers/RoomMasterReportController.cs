...
public class RoomMasterReportController : BaseApiController
{
    private readonly IRoomMasterReportService _svc;
    public RoomMasterReportController(IRoomMasterReportService svc) => _svc = svc;
    ...
    [HttpPost("papers")]
    public async Task<IActionResult> GetPapers([FromBody] RoomMasterPapersRequest request)
    {
    ...
    //public async Task<IActionResult> RunResultProcess([FromBody] RoomResultProcessRequest req)
    //{
